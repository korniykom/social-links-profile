...
export default function Card() {
  return (
    <div className="mb-6 flex max-h-screen max-w-[20.5rem] grow flex-col items-center overflow-y-auto rounded-xl bg-[#1f1f1f] p-6 md:max-w-[28.5rem] xl:max-w-[24rem]">
